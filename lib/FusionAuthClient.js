...
FusionAuthClient.prototype = {
   ...
   * @param {Function} callBack The response handler call back. This function will be passed the ClientResponse object.
   */
  createUserConsentType: function(consentTypeId, request, callBack) {
      return this._start()
          .uri('/api/user/consent/type')
   ...
   * @param {Function} callBack The response handler call back. This function will be passed the ClientResponse object.
   */
  deleteUserConsentType: function(consentTypeId, callBack) {
      return this._start()
          .uri('/api/user/consent/type')
          .urlSegment(consentTypeId)
          .delete()
   ...
   * @param {Function} callBack The response handler call back. This function will be passed the ClientResponse object.
   */
  retrieveUserConsent: function(consentId, callBack) {
      return this._start()
   ...
   * @param {Function} callBack The response handler call back. This function will be passed the ClientResponse object.
   */
  retrieveUserConsentType: function(userConsentTypeId, callBack) {
      return this._start()
          .uri('/api/user/consent/type')
   ...
   * @param {Function} callBack The response handler call back. This function will be passed the ClientResponse object.
   */
  retrieveUserConsentTypes: function(callBack) {
      return this._start()
          .uri('/api/user/consent/type')
          .get()
          .go(callBack);
   ...
   * @param {Function} callBack The response handler call back. This function will be passed the ClientResponse object.
   */
  revokeUserConsent: function(consentId, callBack) {
      return this._start()
          .uri('/api/user/consent')
          .urlSegment(consentId)
          .delete()
   ...
   * @param {Function} callBack The response handler call back. This function will be passed the ClientResponse object.
   */
  updateUserConsent: function(consentId, request, callBack) {
      return this._start()
          .uri('/api/user/consent')
          .urlSegment(consentId)
          .setJSONBody(request)
   ...
   * @param {Function} callBack The response handler call back. This function will be passed the ClientResponse object.
   */
  updateUserConsentType: function(consentTypeId, request, callBack) {
      return this._start()
          .uri('/api/user/consent/type')
          .urlSegment(consentTypeId)
          .setJSONBody(request)
